...
title(".gg/hawkboosts")
clear()
bnr = pyfiglet.figlet_format("HAWK")
#sasuke token
# OTg0NjcwODc0MjM1OTYxMzY2.GvSVd4.ZEUy7kkXS28Vg7SIYK2V7eJaeci7ZxV8PFTJ5c
colors.banner(bnr + "\n")
colors.ask("Delay")
delay = int(input(">>> "))
colors.ask("Chill\n")
token = "OTg0NjcwODc0MjM1OTYxMzY2.GvSVd4.ZEUy7kkXS28Vg7SIYK2V7eJaeci7ZxV8PFTJ5c"
    ...
    async with cs.get(
      ...
      if rs.status in [200, 204, 201]:
        ...
        try:
          ...
          colors.warning("IP CHUDGYA [ IP BANNED ]")
          return
